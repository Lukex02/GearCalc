    ...
    <PaperProvider>
      ...
      >
        ...
        <Stack.Screen
          ...
          options={{ title: "Đăng nhập", headerRight: () => null }}
        />
        <Stack.Screen
          name="src/views/Register"
          options={{ title: "Đăng ký", headerRight: () => null }}
        />
        <Stack.Screen
        ...
        />
        <Stack.Screen
          name="src/views/DesignSelectionScreen"
          options={{ title: "Thiết kế" }}
        />
        <Stack.Screen
          name="src/views/SelectEngineScreen"
          options={{ title: "Động cơ" }}
        />
        <Stack.Screen
          name="src/views/InputDataScreen"
          options={{ title: "Động cơ" }}
        />
        <Stack.Screen
          name="src/views/AdjustEngineParametersScreen"
          options={{ title: "Động cơ" }}
        />
        <Stack.Screen
          name="src/views/PostEngineStatsView"
          options={{ title: "Động cơ" }}
        />
        <Stack.Screen
          name="src/views/SelectChainScreen"
          options={{ title: "Xích" }}
        />
        <Stack.Screen
          name="src/views/PostChainStatsView"
          options={{ title: "Xích" }}
        />
        <Stack.Screen
          name="src/views/GearFast"
          options={{ title: "Bánh răng" }}
        />
        <Stack.Screen
          name="src/views/GearLow"
          options={{ title: "Bánh răng" }}
        />
        <Stack.Screen
          name="src/views/GearResult"
          options={{ title: "Bánh răng" }}
        />
      </Stack>
    </PaperProvider>
